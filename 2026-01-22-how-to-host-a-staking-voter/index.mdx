...
bootstrap load, swapping can turn memory pressure into long disk stalls. A host swapfile may remain as an emergency safeguard, but the
containers are configured to avoid using it.
