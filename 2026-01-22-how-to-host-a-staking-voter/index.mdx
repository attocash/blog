...
may have lying around. Higher-end hardware can improve network performance. A planned scoring model may later take performance into account,
but current reward eligibility follows the published rules.
...
If this is your first time connecting to this server, you will see a warning about the authenticity of the host. Simply write "yes" and press
enter.
...
Your computer is now operating an Atto voter and participating in ORV. Thank you for making a difference!
