...
image: ./decentralization-social-card.jpg
---
...
<IdealImage img={require('./decentralization.jpg')} alt="Split image of a digital sphere with a structured blue network on the left and an abstract, colorful, interconnected network on the right."/>
