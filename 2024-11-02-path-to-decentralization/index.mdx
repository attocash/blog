...
description: Atto is starting centralized to pave the way for true decentralization. Discover why this unconventional path makes sense and how Atto plans to shift control to its community, ensuring stability and growth on the way to full decentralization.
authors: [rotilho]
