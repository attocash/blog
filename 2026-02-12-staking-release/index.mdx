...
These were the practical rules at launch in February 2026. For changes since then, see
[current staking eligibility and programme settings](/docs/staking).
...
For setup, use the [staking docs](https://atto.cash/docs/staking) or the [step-by-step staking tutorial](https://atto.cash/blog/how-to-stake-atto). To compare voters, use the [voter explorer](https://atto.cash/explorer/voters). If you want to run a voter yourself, use the [node integration guide](https://atto.cash/docs/integration/node) for the current deployment configuration and the [voter hosting guide](https://atto.cash/blog/how-to-host-a-staking-voter) for server setup and registration.
